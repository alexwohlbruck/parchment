...
const kbdClass = computed(() => {
  return cva(
    'inline-flex items-center pointer-events-none h-5 select-none items-center gap-1 rounded border border-border bg-muted text-nowrap font-sans font-medium',
    {
      variants: {
        size: {
