...
* One colour picker, everywhere something can be recoloured — a pin, a collection, a layer's styling, a mark on a canvas. All of them now offer the same palette, so picking teal means the same teal wherever you pick it, with a custom colour still available for anything the palette doesn't cover
