...
* Pins on a canvas are drawn the way saved places are, glyph and all — the icon you choose is the icon on the map, in the same marker as everywhere else, instead of a plain dot
