...
/**
 * Grouped departure board for a transit stop / station: route → direction →
 * sorted upcoming departures, with the stop code line and the agency footer.
 *
 * Extracted from PlaceTransitPage so the same board serves both the place
 * sheet sub-page and the routed transit stop/station detail view. Route
 * badges click through to the route detail page.
 */
