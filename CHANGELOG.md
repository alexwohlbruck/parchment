...
* The map follows a reroute too: the isolated line's stations track the running path, and where the agency extends a line onto track it never normally runs — parade-day 4s continuing to New Lots Av — the line is drawn through those stations instead of stopping short of its own dots.
