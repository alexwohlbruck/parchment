...
<template>
  <div
    ...
    :class="cn(
      'focus-within:ring-ring flex h-10 items-center gap-2 rounded-md border border-input bg-background px-3 text-sm ring-offset-background transition-shadow focus-within:ring-1 focus-within:ring-inset',
      props.wrapperClass,
    )"
  >
    <slot name="prefix">
